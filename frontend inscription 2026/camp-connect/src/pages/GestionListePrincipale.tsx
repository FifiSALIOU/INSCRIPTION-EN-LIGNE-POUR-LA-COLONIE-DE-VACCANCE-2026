        ...
        <Card className="glass-card">
          <CardHeader className="pb-3 flex flex-row items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button size="sm" variant="outline" onClick={() => exportToPDF(exportData, "Liste principale", ["Matricule", "Nom du parent", "Prénom du parent", "Service", "Nom de l'enfant", "Prénom de l'enfant", "Âge", "Sexe", "Statut"])}>
